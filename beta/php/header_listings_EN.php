        ...
        <nav id="menuBar" class="navbar navbar-default lightHeader animated " role="navigation">
          <div class="container">
            ...
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="listings_EN.php">
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse navbar-dash">
            <ul class="nav navbar-nav mr0">
              <li class="active">
                <a href="listings_EN.php"><i aria-hidden="true"></i>Welcome:</a>
              </li>
              ...
              <li class="dropdown singleDrop">
                <a href="my_rentals_EN.php" class="scrolling"><i class="fa fa-star-o" aria-hidden="true"></i> Borrower</a>
              </li>
            </ul>
