  ...
  <div class="container">
    <div class="page-header text-center">
      <h1>Como funciona?</h1><br>
        <h2>UniRent é um serviço inovador para estudantes como Tu que precisam de um bem apenas por um curto período de tempo. É seguro, prático e permite que navegues em milhares de bens disponíveis para alugar e atender às tuas necessidades.<br>
      ...
      <div class="col-sm-3 col-xs-10">
        <div class="thumbnail text-center worksContent">
          ...
          <div class="caption">
            ...
            <p>Aluga qualquer bem que precisas diretamente do Proprietário de uma maneira fácil.</p>
          </div>
        </div>
      </div>
      <div class="col-sm-3 col-xs-10">
        <div class="thumbnail text-center worksContent">
          ...
          <div class="caption">
            ...
            <p>Depois de usares devolves o bem ao seu proprietário da forma mais conveniente para ambos.</p>
          </div>
        </div>
      </div>
    <div class="row">
		...
		<div class="row">
			...
			<div class="col-sm-3 col-xs-12">
				<div class="text-center countItem">
					...
					<div class="counterInfo bg-color-4">Tempo de vida da UniRent </div>
				</div>
			</div>
		</div>
		<div class="row">
